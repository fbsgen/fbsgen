...
public class ProtoParserTest extends TestCase
{
    ...
    public void testImport() throws Exception
    {
        ...
        assertEquals(1, testEnumWithDupValue.getValue("FOO1").number);
        assertEquals(1, testEnumWithDupValue.getValue("FOO2").number);
        assertEquals(2, testEnumWithDupValue.getValue("BAR1").number);
        assertEquals(2, testEnumWithDupValue.getValue("BAR2").number);
        assertEquals(3, testEnumWithDupValue.getValue("BAZ").number);
        ...
        assertTrue(testSparseEnum.getValues().get(0).name.equals("SPARSE_E"));
        assertTrue(testSparseEnum.getValues().get(0).number == -53452);
        assertTrue(testSparseEnum.getValues().get(1).name.equals("SPARSE_D"));
        assertTrue(testSparseEnum.getValues().get(1).number == -15);
        assertTrue(testSparseEnum.getValues().get(2).name.equals("SPARSE_F"));
        assertTrue(testSparseEnum.getValues().get(2).number == 0);
        assertTrue(testSparseEnum.getValues().get(3).name.equals("SPARSE_G"));
        assertTrue(testSparseEnum.getValues().get(3).number == 2);
        assertTrue(testSparseEnum.getValues().get(4).name.equals("SPARSE_A"));
        assertTrue(testSparseEnum.getValues().get(4).number == 123);
        assertTrue(testSparseEnum.getValues().get(5).name.equals("SPARSE_B"));
        assertTrue(testSparseEnum.getValues().get(5).number == 62374);
        assertTrue(testSparseEnum.getValues().get(6).name.equals("SPARSE_C"));
        assertTrue(testSparseEnum.getValues().get(6).number == 12589234);
